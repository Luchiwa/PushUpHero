...
import { FriendsTab } from '@screens/FriendsScreen/FriendsTab/FriendsTab';
import { FriendsFeedPanel } from '@screens/FriendsScreen/FriendsFeedPanel/FriendsFeedPanel';
...
export function ProfileModal({ onClose, initialTab }: ProfileModalProps) {
    ...
    return (
        ...
        <PageLayout
            ...
            onClose={onClose}
            rightAction={
                <button type="button" className="btn-icon profile-settings-btn" onClick={() => setShowSettings(true)} aria-label={t('settings_aria')}>
